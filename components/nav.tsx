...
const links = [
  ...
  { href: "/highest-scoring-half", label: "HSH", icon: "⏱️", desktopLabel: "Highest Scoring Half" },
  { href: "/half-comparison-analysis", label: "Half", icon: "🆚", desktopLabel: "Half Comparison" },
  { href: "/conceded-half-analysis", label: "Conc.", icon: "🥅", desktopLabel: "Conceded Half" },
