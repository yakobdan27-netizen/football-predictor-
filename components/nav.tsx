...
const moreLinks: NavLink[] = [
  ...
  { href: "/draw-either-half-analysis", label: "DIEH", icon: "⚖️", desktopLabel: "Draw Either Half" },
  { href: "/total-goals-analysis", label: "Goals", icon: "⚽", desktopLabel: "Total Goals" },
  { href: "/slips/builder", label: "Slips", icon: "📋", desktopLabel: "Slip Builder" },
