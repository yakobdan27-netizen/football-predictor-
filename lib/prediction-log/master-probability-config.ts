...
export const CAPACITY_FIELD_MAP: Partial<Record<LogMarketKey, CapacityFieldMapping>> = {
  ...
  total_goals_ou: GOALS_MAPPING,
  handicap: WIN_MAPPING,
  ht_handicap: WIN_MAPPING,
  three_way_handicap: WIN_MAPPING,
  more_goals_half: GOALS_MAPPING,
  draw_one_half: WIN_MAPPING,
  sot_ou: SOT_MAPPING,
  home_sot_ou: SOT_MAPPING,
  away_sot_ou: SOT_MAPPING,
  shots_ou: SHOTS_MAPPING,
  home_shots_ou: SHOTS_MAPPING,
  away_shots_ou: SHOTS_MAPPING,
  corners_ou: CORNERS_MAPPING,
  home_corners_ou: CORNERS_MAPPING,
